...
contains all raw data required to perform analyses. Due to its size, [`data/raw-data/`] folder was stored on another platform, accessible here: https://www.kaggle.com/datasets/mariecarolineprima/rflc-scp-data-folder
...
contains all intermediate data created during the workflow. Due to its size, [`data/derived-data/`] folder was stored on another platform, accessible here: https://www.kaggle.com/datasets/mariecarolineprima/rflc-scp-data-folder

- [`outputs/`](https://www.kaggle.com/datasets/mariecarolineprima/rflc-scp-outputs-folder):
contains final data created during the workflow. Due to its size, [`outputs/`] folder was stored on another platform, accessible here: https://www.kaggle.com/datasets/mariecarolineprima/rflc-scp-outputs-folder
