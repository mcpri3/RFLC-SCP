...
contains all raw data required to perform analyses. Due to its size, [`data/raw-data/`] folder was stored on another platform, accessible here: https://filesender.renater.fr/?s=download&token=0b5de737-082c-478e-8f64-845251e60ab9
...
contains all intermediate data created during the workflow. Due to its size, [`data/derived-data/`] folder was stored on another platform, accessible here: https://filesender.renater.fr/?s=download&token=0b5de737-082c-478e-8f64-845251e60ab9

- [`outputs/`](https://filesender.renater.fr/?s=download&token=0b5de737-082c-478e-8f64-845251e60ab9):
contains final data created during the workflow. Due to its size, [`outputs/`] folder was stored on another platform, accessible here: https://filesender.renater.fr/?s=download&token=0b5de737-082c-478e-8f64-845251e60ab9
